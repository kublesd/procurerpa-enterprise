...
import enterprise.approval.models  # noqa: F401 - register approval models with Base.metadata
import enterprise.audit.models  # noqa: F401 - register audit models with Base.metadata
