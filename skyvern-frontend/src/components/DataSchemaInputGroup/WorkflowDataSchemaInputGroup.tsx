      ...
      <div className="flex h-7 items-center justify-between">
        <div className="flex gap-4">
          <div className="flex gap-2">
            <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("workflows.dataSchema")}</Label>
            <HelpTooltip
        ...
        >
          <DialogContent className="max-w-4xl">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label className="text-sm" style={{ color: "var(--procurerpa-text-muted)" }}>{t("workflows.currentSchema")}</Label>
                <CodeEditor
                  language="json"
                  value={value}
                  readOnly
