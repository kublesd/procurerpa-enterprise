    ...
    <div style={{ borderRadius: "var(--radius-lg)", boxShadow: "var(--glass-shadow)", overflow: "hidden" }}>
      ...
      >
        <div className="mx-auto flex min-w-44 flex-col items-center gap-7 px-8">
          <span className="text-2xl" style={{ color: "var(--procurerpa-text-primary)" }}>
          ...
          <div className="flex w-full max-w-xl flex-col">
            ...
            >
              <AutoResizingTextarea
                ...
                style={{ color: "var(--procurerpa-text-primary)", background: "transparent" }}
                value={prompt}
                  ...
                  {selectValue === "v2-code" ? (
                    <div className="relative z-10 flex w-full flex-col items-center">
                      <div className="flex items-center gap-1">
                        ...
                        <div className="font-normal" style={{ color: "var(--procurerpa-text-primary)" }}>
                          ProcureRPA 2.0
                        </div>
                      </div>
                ...
                <SelectContent style={{ background: "var(--glass-bg)", border: "1px solid var(--glass-border)" }}>
                  <CustomSelectItem value="v1" className="hover:bg-slate-100">
                    <div className="space-y-2">
                      <div>
                        <SelectItemText><span style={{ color: "var(--procurerpa-text-primary)" }}>ProcureRPA 1.0</span></SelectItemText>
                      </div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
                  ...
                  <CustomSelectItem value="v2" className="hover:bg-slate-100">
                    <div className="space-y-2">
                      <div>
                        <SelectItemText><span style={{ color: "var(--procurerpa-text-primary)" }}>ProcureRPA 2.0</span></SelectItemText>
                      </div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
              ...
              >
                {generateWorkflowMutation.isPending ? (
                  <ReloadIcon className="size-6 animate-spin" style={{ color: "var(--procurerpa-text-secondary)" }} />
                ) : (
                  <PaperPlaneIcon
                    className="size-6 cursor-pointer"
                    style={{ color: "var(--procurerpa-text-secondary)" }}
            ...
            {showAdvancedSettings ? (
              <div className="rounded-b-lg px-2">
                <div className="space-y-4 rounded-b-xl p-4" style={{ background: "var(--glass-bg)", border: "1px solid var(--glass-border)" }}>
                  <header style={{ color: "var(--procurerpa-text-primary)" }}>{t("tasks.advanced")}</header>
                  <div className="flex gap-16">
                    <div className="w-48 shrink-0">
                      <div className="text-sm" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.webhookUrl")}</div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
                  ...
                  <div className="flex gap-16">
                    <div className="w-48 shrink-0">
                      <div className="text-sm" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.proxyLocation")}</div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
                        {t("tasks.proxyHelper")}
                      </div>
                    </div>
                  ...
                  <div className="flex gap-16">
                    <div className="w-48 shrink-0">
                      <div className="text-sm" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.browserSessionId")}</div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
                  ...
                  <div className="flex gap-16">
                    <div className="w-48 shrink-0">
                      <div className="text-sm" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.browserAddress")}</div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
                  ...
                  <div className="flex gap-16">
                    <div className="w-48 shrink-0">
                      <div className="text-sm" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.twoFAIdentifier")}</div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
                  ...
                  <div className="flex gap-16">
                    <div className="w-48 shrink-0">
                      <div className="text-sm" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.extraHttpHeaders")}</div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
                  ...
                  <div className="flex gap-16">
                    <div className="w-48 shrink-0">
                      <div className="text-sm" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.generateScript")}</div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
                  ...
                  <div className="flex gap-16">
                    <div className="w-48 shrink-0">
                      <div className="text-sm" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.publishWorkflow")}</div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
                  ...
                  <div className="flex gap-16">
                    <div className="w-48 shrink-0">
                      <div className="text-sm" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.maxSteps")}</div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
                  ...
                  <div className="flex gap-16">
                    <div className="w-48 shrink-0">
                      <div className="text-sm" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.dataSchema")}</div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
                  ...
                  <div className="flex gap-16">
                    <div className="w-48 shrink-0">
                      <div className="text-sm" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.maxScreenshotScrolls")}</div>
                      <div className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
