    ...
    <div className="space-y-8">
      ...
      <div className="flex w-fit gap-0.5 rounded-lg p-1" style={{ background: "rgba(26,58,92,0.06)" }}>
        <div
          ...
          style={{
            color: view === "history" ? "white" : "var(--procurerpa-text-muted)",
            background: view === "history" ? "var(--procurerpa-blue)" : undefined,
          }}
        ...
        <div
          ...
          style={{
            color: view === "myTasks" ? "white" : "var(--procurerpa-text-muted)",
            background: view === "myTasks" ? "var(--procurerpa-blue)" : undefined,
          }}
