      ...
      <div className="border" style={{ borderRadius: "var(--radius-lg)", boxShadow: "var(--glass-shadow)", borderColor: "var(--glass-border)", overflow: "hidden" }}>
        <Table>
          <TableHeader style={{ background: "rgba(26,58,92,0.06)" }}>
            <TableRow>
              <TableHead className="w-1/4" style={{ color: "var(--procurerpa-text-muted)" }}>{t("tasks.tableId")}</TableHead>
              <TableHead className="w-1/4" style={{ color: "var(--procurerpa-text-muted)" }}>{t("tasks.url")}</TableHead>
              <TableHead className="w-1/6" style={{ color: "var(--procurerpa-text-muted)" }}>{t("tasks.status")}</TableHead>
              <TableHead className="w-1/4" style={{ color: "var(--procurerpa-text-muted)" }}>{t("tasks.createdAt")}</TableHead>
              <TableHead className="w-1/12" style={{ color: "var(--procurerpa-text-muted)" }} />
            </TableRow>
          </TableHeader>
          <TableBody>
            {isPending ? (
