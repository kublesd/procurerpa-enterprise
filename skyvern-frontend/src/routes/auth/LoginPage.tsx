      ...
      >
        ...
        <p
          style={{
            textAlign: "center",
            fontSize: 14,
            color: "var(--procurerpa-text-muted)",
            margin: 0,
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: "var(--space-md)" }}>
            <Label
              ...
              style={{ color: "var(--procurerpa-text-secondary)", marginBottom: 6, display: "block" }}
            >
        ...
        <div
          style={{
            ...
            borderRadius: 2,
            background:
              "linear-gradient(90deg, var(--procurerpa-blue) 0%, var(--procurerpa-gold) 100%)",
            opacity: 0.5,
          }}
        />
      </div>
