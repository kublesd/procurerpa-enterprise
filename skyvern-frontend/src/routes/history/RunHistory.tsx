      ...
      <div className="border" style={{ borderRadius: "var(--radius-lg)", boxShadow: "var(--glass-shadow)", borderColor: "var(--glass-border)", overflow: "hidden" }}>
        <Table>
          <TableHeader className="rounded-t-lg" style={{ background: "rgba(26,58,92,0.06)" }}>
            <TableRow>
              <TableHead className="w-1/5 rounded-tl-lg" style={{ color: "var(--procurerpa-text-muted)" }}>
                {t("runs.runId")}
              </TableHead>
              <TableHead className="w-1/5" style={{ color: "var(--procurerpa-text-muted)" }}>{t("runs.detail")}</TableHead>
              <TableHead className="w-1/5" style={{ color: "var(--procurerpa-text-muted)" }}>{t("common.status")}</TableHead>
              <TableHead className="w-1/5" style={{ color: "var(--procurerpa-text-muted)" }}>{t("tasks.createdAt")}</TableHead>
              <TableHead className="w-1/5 rounded-tr-lg" style={{ color: "var(--procurerpa-text-muted)" }}></TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {isFetching ? (
...
function WorkflowRunParametersInline({
  ...
  if (!hasParameters && !hasExtraHeaders) {
    return (
      <div className="ml-8 py-4 text-sm" style={{ color: "var(--procurerpa-text-muted)" }}>
        {t("runs.noParameters")}
      </div>
    );
  }
