    ...
    <>
      <div className="flex gap-16">
        <div className="w-80">
          ...
          <h2 className="text-base" style={{ color: "var(--procurerpa-text-muted)" }}>
      ...
      {showValidationParameters ? (
        <div className="flex gap-16">
          <div className="w-80">
            ...
            <h2 className="text-base" style={{ color: "var(--procurerpa-text-muted)" }}>{t("tasks.completionCriteriaDesc")}</h2>
          </div>
          <AutoResizingTextarea
      ...
      {showValidationParameters ? (
        <div className="flex gap-16">
          <div className="w-80">
            ...
            <h2 className="text-base" style={{ color: "var(--procurerpa-text-muted)" }}>{t("tasks.terminationCriteriaDesc")}</h2>
          </div>
          <AutoResizingTextarea
      ...
      <div className="flex gap-16">
        ...
        <div className="flex w-full items-center gap-3">
          ...
          <span className="text-sm" style={{ color: "var(--procurerpa-text-muted)" }}>
      ...
      {hasAdvancedSettings ? (
        <>
          <h2 className="text-base font-semibold" style={{ color: "var(--procurerpa-text-secondary)" }}>
          ...
          {completeOnDownload === true ? (
            <div className="flex gap-16">
              ...
              <div className="flex w-full items-center gap-3">
                ...
                <span className="text-sm" style={{ color: "var(--procurerpa-text-muted)" }}>{t("common.enabled")}</span>
              </div>
            </div>
          ) : null}
