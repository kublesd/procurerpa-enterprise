      ...
      >
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="rounded border px-2 py-1 text-xs hover:bg-muted" style={{ borderColor: "var(--glass-border)", color: "var(--procurerpa-text-secondary)" }}
          >
            {t("workflows.newChat")}
          </button>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="space-y-3">
          {!isLoadingHistory && messages.length === 0 && !isLoading ? (
            <div className="rounded-lg border p-4 text-sm" style={{ borderColor: "var(--glass-border)", background: "rgba(26,58,92,0.06)", color: "var(--procurerpa-text-secondary)" }}>
