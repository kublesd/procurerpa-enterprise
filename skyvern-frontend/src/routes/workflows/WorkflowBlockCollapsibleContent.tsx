                ...
                <div className="flex gap-1">
                  {statusIsFinalized(task) && (
                    <div
                      ...
                      style={activeTab !== "output" ? { color: "var(--procurerpa-text-muted)" } : undefined}
                      onClick={() => {
                        setActiveTab("output");
                      }}
                    >
                  ...
                  <div
                    ...
                    style={activeTab !== "goal" ? { color: "var(--procurerpa-text-muted)" } : undefined}
                    onClick={() => {
                      setActiveTab("goal");
                    }}
                  >
                  ...
                  <div
                    ...
                    style={activeTab !== "parameters" ? { color: "var(--procurerpa-text-muted)" } : undefined}
                    onClick={() => {
