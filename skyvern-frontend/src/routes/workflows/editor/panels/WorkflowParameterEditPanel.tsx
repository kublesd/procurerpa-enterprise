...
function getAvailableSourcesForDataType(
  ...
  switch (dataType) {
    case "password":
      return [
        ...(isCloud ? [{ value: "skyvern" as const, label: "ProcureRPA" }] : []),
      ...
      <ScrollAreaViewport className="max-h-[500px]">
        <div className="space-y-4 p-1 px-4">
          ...
          <div className="space-y-1">
            <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.key")}</Label>
          ...
          <div className="space-y-1">
            <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.description")}</Label>
            <Input
              value={description}
          ...
          {showCredentialFields && (
            <>
              ...
              <div className="space-y-1">
                <div className="flex gap-2">
                  <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.source")}</Label>
          ...
          {showBitwardenSecretFields && (
            <>
              ...
              <div className="space-y-1">
                <div className="flex gap-2">
                  <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.identityKey")}</Label>
          ...
          {showSkyvernCredentialSelector && (
            <div className="space-y-1">
              <div className="flex gap-2">
                <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>
                  {t("editor.procurerpaCredential")}
                </Label>
                <HelpTooltip content={t("editor.procurerpaCredentialHelp")} />
              </div>
          ...
          {type === "context" && (
            <div className="space-y-1">
              <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.sourceParameter")}</Label>
