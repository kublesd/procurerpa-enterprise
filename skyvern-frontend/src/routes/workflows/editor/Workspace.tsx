    ...
    <div className="flex items-center justify-end">
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent>
          ...
          <div>
            <div>1. Install ProcureRPA: {bash("pip install procurerpa")}</div>
            <div>2. Set up ProcureRPA: {bash("procurerpa quickstart")}</div>
            <div>
            ...
            <div>
              4. Run the code:{" "}
              {bash(
                'procurerpa run code --params \'{"param1": "val1", "param2": "val2"}\' main.py',
              )}
            </div>
          </div>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              <div className="pb-2 pt-4 text-sm" style={{ color: "var(--procurerpa-text-muted)" }}>
