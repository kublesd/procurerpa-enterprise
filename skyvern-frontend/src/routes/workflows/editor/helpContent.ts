export const baseHelpTooltipContent = {
  url: "The URL ProcureRPA is navigating to. Leave this field blank to pick up from where the last block left off.",
  navigationGoal:
    "Give ProcureRPA an objective. Make sure to include when the block is complete, when it should self-terminate, and any guardrails. Use {{ parameter_name }} to reference a parameter value",
  parameters:
    'Define placeholder values using the "parameters" drop down that you predefine or redefine run-to-run.',
  dataExtractionGoal:
    "Tell ProcureRPA what data you would like to scrape at the end of your run.",
  ...
  completeOnDownload:
    "Allow ProcureRPA to auto-complete the block when it downloads a file.",
  fileSuffix:
  ...
  engine:
    "ProcureRPA 1.0: Fast, single-goal tasks. ProcureRPA 2.0: Complex, multi-goal tasks (slower).",
} as const;

export const basePlaceholderContent = {
  url: "(optional) Navigate to this URL: https://...",
  navigationGoal: "Tell ProcureRPA what to do.",
...
export const helpTooltips = {
  ...
  extraction: {
    ...baseHelpTooltipContent,
    dataExtractionGoal:
      "Tell ProcureRPA what data you would like to scrape. Use {{ parameter_name }} to specify parameters to use.",
  },
  action: {
    ...baseHelpTooltipContent,
    navigationGoal:
      "Specify a single step or action you'd like ProcureRPA to complete. Actions are one-off tasks like filling a field or interacting with a specific element on the page.\n\nCurrently supported actions are click, input text, upload file, and select. Use {{ parameter_name }} to specify parameters to use.",
  },
  fileDownload: {
    ...baseHelpTooltipContent,
    navigationGoal:
      "Give ProcureRPA an objective that describes how to download the file.",
  },
...
export const placeholders = {
  ...
  taskv2: {
    ...
    prompt: "Tell ProcureRPA what to do",
  },
  navigation: {
    ...basePlaceholderContent,
    navigationGoal:
  ...
  fileDownload: {
    navigationGoal: "Tell ProcureRPA which file to download.",
  },
