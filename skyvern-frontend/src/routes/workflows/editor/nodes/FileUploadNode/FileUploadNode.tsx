        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <Label className="text-sm" style={{ color: "var(--procurerpa-text-muted)" }}>{t("editor.storageType")}</Label>
              <HelpTooltip
          ...
          {data.storageType === "s3" && (
            <>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <Label className="text-sm" style={{ color: "var(--procurerpa-text-muted)" }}>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <Label className="text-sm" style={{ color: "var(--procurerpa-text-muted)" }}>{t("editor.s3Bucket")}</Label>
                  <HelpTooltip
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <Label className="text-sm" style={{ color: "var(--procurerpa-text-muted)" }}>{t("editor.regionName")}</Label>
                  <HelpTooltip
