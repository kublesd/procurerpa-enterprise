    ...
    >
      ...
      >
        ...
        <div className="space-y-2">
          <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>Input Parameters</Label>
        ...
        <div className="space-y-2">
          <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>Code Input</Label>
          <CodeEditor
            language="python"
            value={data.code}
            onChange={(value) => {
