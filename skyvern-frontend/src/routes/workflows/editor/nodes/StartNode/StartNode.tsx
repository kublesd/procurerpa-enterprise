  ...
  return (
    ...
    >
      <Handle
        ...
        className="opacity-0"
      />
      <div className="w-[30rem] rounded-lg bg-slate-elevation4 px-6 py-4 text-center text-xs font-semibold uppercase tracking-[0.2em]" style={{ color: "var(--procurerpa-text-muted)" }}>
        {t("editor.start")}
        {isInsideLoop && (
          <div className="mt-4 flex gap-3 rounded-md p-3 normal-case tracking-normal" style={{ background: "rgba(26,58,92,0.06)" }}>
            ...
            <div className="space-y-1 text-left font-normal" style={{ color: "var(--procurerpa-text-muted)" }}>
        ...
        {isInsideConditional && (
          <div className="mt-4 rounded-md border border-dashed p-4 text-center font-normal normal-case tracking-normal" style={{ borderColor: "var(--glass-border)", color: "var(--procurerpa-text-secondary)" }}>
