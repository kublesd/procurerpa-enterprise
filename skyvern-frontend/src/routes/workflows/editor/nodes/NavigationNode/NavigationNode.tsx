      ...
      >
        ...
        <div className="space-y-2">
          <div className="flex justify-between">
            <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.prompt")}</Label>
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-2">
            <Label className="text-xs font-normal" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.engine")}</Label>
        ...
        <AccordionItem value="advanced" className="border-b-0">
          ...
          <AccordionContent key={rerender.key} className="pl-6 pr-1 pt-4">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex gap-2">
                  <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.maxSteps")}</Label>
    ...
    <>
      ...
      >
        ...
        <div className="rounded-md p-2" style={{ background: "var(--glass-bg)" }}>
          <div className="space-y-1 text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
        ...
        <AccordionItem value="advanced" className="border-b-0">
          ...
          <AccordionContent className="pl-6 pr-1 pt-1">
            <div key={rerender.key} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.completeIf")}</Label>
                <WorkflowBlockInputTextarea
              ...
              <div className="flex items-center justify-between">
                <div className="flex gap-2">
                  <Label className="text-xs font-normal" style={{ color: "var(--procurerpa-text-secondary)" }}>
