    ...
    >
      ...
      <div className="transform-origin-center w-[30rem] space-y-4 rounded-lg bg-slate-elevation3 px-6 py-4 transition-all">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            <div className="w-32 space-y-2">
              <div className="flex gap-2">
                <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.method")}</Label>
            ...
            <div className="flex-1 space-y-2">
              <div className="flex justify-between">
                <div className="flex gap-2">
                  <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("tasks.url")}</Label>
                  <HelpTooltip content={helpTooltips["httpRequest"]["url"]} />
                </div>
                {isFirstWorkflowBlock ? (
                  <div className="flex justify-end text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex gap-2">
                <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.headers")}</Label>
          ...
          {showBodyEditor && (
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <div className="flex gap-2">
                  <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.body")}</Label>
          ...
          {showBodyEditor && (
            <div className="space-y-2">
              <div className="flex gap-2">
                <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.files")}</Label>
            ...
            <AccordionContent key={rerender.key} className="pl-6 pr-1 pt-1">
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  <div className="w-32 space-y-2">
                    <div className="flex gap-2">
                      <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.timeout")}</Label>
                  ...
                  <div className="flex-1 space-y-2">
                    <div className="flex gap-2">
                      <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>
                        {t("editor.followRedirects")}
                      </Label>
                      <HelpTooltip content={helpTooltips["httpRequest"]["followRedirects"]} />
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
        ...
        <div className="rounded-md p-3" style={{ background: "var(--glass-bg)" }}>
          <div className="space-y-2 text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
            <div className="flex items-center gap-2">
