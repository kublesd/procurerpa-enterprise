    ...
    <div className="rounded-md border p-3" style={{ background: "rgba(26,58,92,0.06)" }}>
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-sm" style={{ color: "var(--procurerpa-text-muted)" }}>
      ...
      {expanded && (
        <div className="mt-3 space-y-2">
          ...
          <div>
            ...
            <pre className="overflow-x-auto rounded p-2 text-xs" style={{ background: "rgba(26,58,92,0.06)", color: "var(--procurerpa-text-muted)" }}>
              {headers || "{}"}
            </pre>
          </div>
