      ...
      <div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex gap-2">
                <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>Login Goal</Label>
                <HelpTooltip
            ...
            <div className="space-y-2">
              <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>Credential</Label>
