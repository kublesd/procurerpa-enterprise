      ...
      <div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex gap-2">
                <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.downloadGoal")}</Label>
            ...
            <div className="rounded-md p-2 text-xs" style={{ background: "var(--glass-bg)", color: "var(--procurerpa-text-muted)" }}>
