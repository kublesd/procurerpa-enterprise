      ...
      >
        ...
        >
          ...
          <div className="space-between flex items-center gap-2">
            <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.timeoutMinutes")}</Label>
          ...
          <div className="space-y-4 rounded-md p-4" style={{ background: "rgba(26,58,92,0.06)" }}>
            ...
            <div className="space-y-2">
              <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.recipients")}</Label>
              <WorkflowBlockInput
                nodeId={id}
                onChange={(value) => {
            ...
            <div className="space-y-2">
              <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.subject")}</Label>
              <WorkflowBlockInput
                nodeId={id}
                onChange={(value) => {
