      ...
      >
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.pageFormat")}</Label>
            <Select
              value={data.format}
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-2">
              <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{t("editor.printBackground")}</Label>
