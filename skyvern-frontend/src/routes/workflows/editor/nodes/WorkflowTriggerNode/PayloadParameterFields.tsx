      ...
      {parameters.map((param) => (
        <div key={param.key} className="space-y-1.5">
          <div className="flex items-baseline gap-2">
            <Label className="text-xs" style={{ color: "var(--procurerpa-text-secondary)" }}>{param.key}</Label>
            <span className="text-[10px]" style={{ color: "var(--procurerpa-text-muted)" }}>
              {param.workflow_parameter_type}
            </span>
          </div>
          {param.description && (
            <p className="text-[10px]" style={{ color: "var(--procurerpa-text-muted)" }}>{param.description}</p>
          )}
          {param.workflow_parameter_type ===
