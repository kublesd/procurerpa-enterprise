    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          style={currentFolderId ? undefined : { color: "var(--procurerpa-text-muted)" }}
        >
      ...
      >
        <div className="border-b p-3">
          ...
          <div className="relative">
            <MagnifyingGlassIcon className="absolute left-2 top-1/2 h-4 w-4 -translate-y-1/2" style={{ color: "var(--procurerpa-text-muted)" }} />
            <Input
        ...
        >
          ...
          {(isFetching || isTyping) && folders.length === 0 ? (
            ...
            <div className="px-3 py-8 text-center text-sm" style={{ color: "var(--procurerpa-text-muted)" }}>
              No folders found
            </div>
          ) : (
            <>
              ...
              {isFetchingNextPage && (
                <div className="flex items-center justify-center py-2">
                  <ReloadIcon className="h-3 w-3 animate-spin" style={{ color: "var(--procurerpa-text-muted)" }} />
                </div>
              )}
            </>
          )}
