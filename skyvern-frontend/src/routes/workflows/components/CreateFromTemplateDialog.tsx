      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-4">
          <div className="relative">
            <MagnifyingGlassIcon className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2" style={{ color: "var(--procurerpa-text-muted)" }} />
            <Input
              value={search}
          ...
          <div className="max-h-[400px] overflow-y-auto">
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <BookmarkFilledIcon className="mb-3 h-10 w-10" style={{ color: "var(--procurerpa-text-muted)" }} />
                {templates.length === 0 ? (
                  <>
                ...
                {filteredTemplates.map((template) => (
                  ...
                  >
                    ...
                    {template.description && (
                      <p className="line-clamp-2 text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
                        {template.description}
                      </p>
                    )}
                    <p className="text-xs" style={{ color: "var(--procurerpa-text-muted)" }}>
