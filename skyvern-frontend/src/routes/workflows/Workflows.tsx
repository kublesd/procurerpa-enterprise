    ...
    <div className="space-y-10">
      <div className="flex h-32 justify-between gap-6">
        <div className="space-y-5">
          ...
          <p style={{ color: "var(--procurerpa-text-secondary)" }}>
          ...
          {recentFolders.length > 0 ? (
            ...
            <div className="border py-6 text-center" style={{ background: "var(--glass-bg)", borderRadius: "var(--radius-lg)", borderColor: "var(--glass-border)", boxShadow: "var(--glass-shadow)" }}>
              <div className="mx-auto max-w-md">
                ...
                <h3 className="mb-2" style={{ color: "var(--procurerpa-text-primary)" }}>
                  {t("workflows.organizeFolders")}
                </h3>
                <p className="mb-4 text-sm" style={{ color: "var(--procurerpa-text-muted)" }}>
        ...
        <div className="border" style={{ borderRadius: "var(--radius-lg)", boxShadow: "var(--glass-shadow)", borderColor: "var(--glass-border)", overflow: "hidden" }}>
          <Table className="table-fixed">
            <TableHeader className="rounded-t-lg" style={{ background: "rgba(26,58,92,0.06)" }}>
              <TableRow>
                <TableHead className="w-[25%] rounded-tl-lg" style={{ color: "var(--procurerpa-text-muted)" }}>
                  {t("workflows.tableId")}
                </TableHead>
                <TableHead className="w-[30%]" style={{ color: "var(--procurerpa-text-muted)" }}>{t("workflows.tableTitle")}</TableHead>
                <TableHead className="w-[15%]" style={{ color: "var(--procurerpa-text-muted)" }}>{t("workflows.tableFolder")}</TableHead>
                <TableHead className="w-[15%]" style={{ color: "var(--procurerpa-text-muted)" }}>
                  {t("tasks.createdAt")}
                </TableHead>
                    ...
                    <React.Fragment key={workflow.workflow_permanent_id}>
                      ...
                      {isUploading ? (
                        <TableRow className="opacity-70">
                          ...
                          <TableCell>
                            <span style={{ color: "var(--procurerpa-text-muted)" }}>-</span>
                          </TableCell>
                          <TableCell>
          ...
          <div className="relative px-3 py-3">
            <div className="absolute left-3 top-1/2 flex -translate-y-1/2 items-center gap-2 text-sm">
              <span style={{ color: "var(--procurerpa-text-muted)" }}>{t("runs.itemsPerPage")}</span>
              <select
