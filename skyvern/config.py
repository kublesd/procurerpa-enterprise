...
class Settings(BaseSettings):
    ...
    PROCUREMENT_LIGHT_LLM_KEY: str | None = None
    PROCUREMENT_STANDARD_LLM_KEY: str | None = None
    PROCUREMENT_HEAVY_LLM_KEY: str | None = None
    ...
    def get_model_name_to_llm_key(self) -> dict[str, dict[str, str]]:
        ...
        mapping: dict[str, dict[str, str]] = {
            ...
            "gemini-3.6-flash": {"llm_key": "GEMINI_3.6_FLASH", "label": "Gemini 3.6 Flash"},
