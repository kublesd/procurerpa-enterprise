        ...
        async def llm_api_handler_with_router_and_fallback(
            ...
            try:
                ...
                try:
                    ...
                    raise LLMProviderErrorRetryableTask(llm_key) from None
                    ...
                    raise SkyvernContextWindowExceededError() from None
        ...
        **extra_parameters: Any,
        ...
        try:
            ...
            try:
                ...
                raise LLMProviderErrorRetryableTask(self.llm_key) from None
            except litellm.exceptions.ContextWindowExceededError as e:
                LOG.error(
                    "Context window exceeded",
