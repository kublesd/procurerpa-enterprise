...
class ActionType(str, enum.Enum):
    """Browser actions and procurement business events."""
...
class AuditLogModel(Base):
    ...
    business_object_type = Column(String, nullable=True)
    business_object_id = Column(String, nullable=True)
    ...
    __table_args__ = (
        ...
        Index("idx_aud_business_object", "business_object_type", "business_object_id"),
        CheckConstraint(
            "action_index >= 0",
