...
class UserContext(BaseModel):
    ...
    procurement_category_ids: list[str] = Field(default_factory=list)
    has_cross_org_read: bool = False
    has_cross_org_approve: bool = False
    ...
    def has_procurement_category(self, category_id: str) -> bool:
        return category_id in self.procurement_category_ids
