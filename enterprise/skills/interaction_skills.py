"""Procurement interaction skills: forms, search, and pagination.

Handle common UI interaction patterns across supplier and procurement systems.
"""
...
class FormFillSkill(BaseSkill):
    ...
    common in procurement systems (custom dropdowns, date pickers, etc.).
    """
...
class SearchAndSelectSkill(BaseSkill):
    ...
    Common in procurement systems for supplier, material, RFQ, and order lookup.
    """
...
class PaginationSkill(BaseSkill):
    ...
    commonly found in supplier, quote, and order tables.
    """
