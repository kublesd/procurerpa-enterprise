"""Procurement extraction skills: tables and controlled downloads.

Handle extraction of quotes, delivery dates, MOQ, tax, contract rows,
and supplier attachments from procurement pages.
"""
...
class TableExtractSkill(BaseSkill):
    ...
    common in supplier and procurement portals. Outputs JSON or CSV.
    """
