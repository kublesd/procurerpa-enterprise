"""Procurement portal authentication skills.

These handle common login flows and session management across
supplier, procurement, and contract portals.
"""
...
class LoginParams(BaseModel):
    """Parameters for a supplier or procurement portal login."""
...
class LoginSkill(BaseSkill):
    """Generic login skill for supplier and procurement portals.
...
class SessionKeepAliveSkill(BaseSkill):
    ...
    supplier portal expiry indicators. Re-authenticates if needed.
    """
